...
public class Login_MyLocationMaps extends FragmentActivity implements OnMapReadyCallback,
    ...
    private String url = "https://official-menambal.000webhostapp.com/android/me-nambal/mylocation_tambalban.php";
    private String url_bensin = "https://official-menambal.000webhostapp.com/android/me-nambal/mylocation_bensineceran.php";

    //save
    private static final String TAG = Login_MyLocationMaps.class.getSimpleName();
    private String UPLOAD_URL = "https://official-menambal.000webhostapp.com/android/me-nambal/upload.php";
    ...
    private static File getOutputMediaFile() {
        ...
        File mediaStorageDir = new File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_PICTURES), "Me-Nambal");
        ...
        File mediaFile;
        mediaFile = new File(mediaStorageDir.getPath() + File.separator + "IMG_Me-Nambal_" + timeStamp + ".jpg");
